...
Not written yet: sorting, filtering, find and replace, and the PDF, HTML, and ODS exports. Keyboard navigation works but has not been gone over properly, there is no context menu, the icon is a placeholder, and there are no translations yet.
